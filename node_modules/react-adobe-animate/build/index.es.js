...
const startAnimation = (id, fps, animationObject, stage) => {
...
const useSetupAdobe = ({ animationName, composition: externalCompositionId, getAnimationObject, paused, onError, canvasRef, }) => {
    ...
    const animationObjectRef = useRef();
...
const AnimateCC = (props) => {
    ...
    const color = useMemo(() => properties
        ? hexToRgba(properties.color, properties.opacity)
        : 'transparent', [properties]);
    const { width: canvasWidth, height: canvasHeight } = getCanvasSize(properties);
    return (jsx("div", { children: jsxs("div", Object.assign({ style: Object.assign({ width: '100%', height: '100%' }, additionalStyles) }, rest, { children: [jsx("canvas", { ref: canvasRef, width: canvasWidth, height: canvasHeight, style: Object.assign({ display: 'block', width: '100%', backgroundColor: color }, additionalCanvasStyles) }), jsx("div", { style: {
                        pointerEvents: 'none',
                        overflow: 'hidden',
...
export { AnimateCC, AnimateCC as default };
